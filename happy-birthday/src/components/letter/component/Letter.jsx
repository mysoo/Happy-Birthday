  ...
  return (
    <Section>
      <LetterBox>
        ...
        하고싶어 놀기 위해서~!!ㅋㅋㅋㅋ ㅎㅎ
        <br />
        아무튼 생일 축하해!!!ㅎㅎㅎ 우리 이제 8년째 생일을 같이 보내구 있어!!
        <br />
        우리 언제 스물다섯이 된거지,,~!ㅋㅋㅋㅋ 정말 소름돋아,,, 너는 직장인이구
        나는 취업을 준비하고 있다니,,
        <br />
        내년에는 둘 다 나름 여유있겠지,,!?!? 우리 진짜 꼬옥 해외여행가자ㅜㅠㅜㅠ
        놀러가고시포ㅜㅠㅜ가서 신나게 놀자. 일단 나는 몰디브, 태국,
        코타키나발루, 방콕, 대만, 베트남, 파리 정도 가고싶어^^
        <br />
        오늘 헐크씨랑 행복하게 보내구~! 맛있는것두 많이 먹구!!!ㅎㅎㅎ
        <br />
        우리는 다음주에 재밌게 놀쟈 ㅎㅎㅎㅎ
        <br />
        생일축하해오~~~~(하투)
      </LetterBox>
    </Section>
